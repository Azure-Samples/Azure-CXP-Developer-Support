...
# This sample shell script is to configure linked services in acr using json format configuration file
# Before running this script, create an Azure Container Registry within your subscription.
